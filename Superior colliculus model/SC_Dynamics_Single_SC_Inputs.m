...
Sim.xyGroup1 = [10,8]; % set (x,y) location of group centre
...
% SNr neurons to turn off around (x,y) location of command input
Net.SNrRadius = 1; % floor(Sim.dThresh / Net.SNr_xy_resolution);   % radius of SNr neurons to turn off from centre point - counts along x or y axis
Sim.SNrOff = 0; % Sim.bSNr;  % what value is "off": 0 or Sim.bSNr to have no response to input
